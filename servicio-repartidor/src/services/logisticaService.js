...
class LogisticaService {
    ...
    // Funciones de dominio de Repartidores
    ...
    async asignarPedido(pedidoId) {
        // Le pregunta al servicio central (puerto 3000) por el objeto real y su peso
        ...
        // Busca en la base de datos local un camión disponible
        ...
        // Altera la carga del repartidor de forma local
        disponible.asignarCarga(pesoDelPaquete);

        // Notifica de vuelta al servicio de pedidos para que actualice SU máquina de estados
